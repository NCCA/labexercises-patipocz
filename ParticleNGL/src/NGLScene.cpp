...
const auto ColourShader="ColourShader";     //defensive coding less mistakes than withg string literal
...
void NGLScene::initializeGL()
{
  ...
  m_emitter=std::make_unique<Emitter>(100000,ngl::Vec3(0.0f,10.0f,0.0f));
